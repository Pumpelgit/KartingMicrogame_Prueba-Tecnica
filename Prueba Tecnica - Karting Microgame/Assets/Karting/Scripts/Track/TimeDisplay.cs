...
namespace KartGame.Track
{
    ...
    public class TimeDisplay : MonoBehaviour
    {
        ...
        public static Action OnLapsFinished;
        ...
        [Tooltip("Prefab for the record best time message")]
        public DisplayMessage recordBestTimeMessage;
        void Awake()
        {
        ...
        void OnEnable()
        {
            ...
            OnSetLaps += SetLaps;
            SaveManager.OnLoadData += SetAllTimeBest;
        }

        private void SetAllTimeBest(PlayerData playerData)
        {
